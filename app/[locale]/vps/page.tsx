...
const vpsPlans = [
  {
    ...
    price: 15000,
    currency: 'IQD',
    specs: { cpu: '1 Core', ram: '4 GB', storage: '50 GB NVMe', bandwidth: '2 TB' },
  ...
  },
  {
    ...
    price: 25000,
    currency: 'IQD',
    specs: { cpu: '2 Cores', ram: '8 GB', storage: '100 GB NVMe', bandwidth: '5 TB' },
    features: ['1 IPv4 Address', '/64 IPv6', 'DDoS Protection', 'Instant Setup', '24/7 Support', 'Weekly Backups'],
    popular: true,
  },
  {
    ...
    price: 45000,
    currency: 'IQD',
    specs: { cpu: '4 Cores', ram: '16 GB', storage: '200 GB NVMe', bandwidth: '10 TB' },
    features: ['1 IPv4 Address', '/64 IPv6', 'DDoS Protection', 'Instant Setup', '24/7 Support', 'Daily Backups', 'Priority Support'],
    popular: false,
  },
  {
    name: 'VPS-32',
    price: 85000,
    currency: 'IQD',
    specs: { cpu: '8 Cores', ram: '32 GB', storage: '400 GB NVMe', bandwidth: 'Unlimited' },
